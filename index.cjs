'use strict';
// Central Bank of Libya exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbl';
...
/** Latest rate for one pair, e.g. getRate('USD', 'LYD', { apiKey }). */
